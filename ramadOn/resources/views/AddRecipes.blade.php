    ...
    <nav class="bg-emerald-800 text-white shadow-md">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <a href="{{route('publishing')}}" class="text-amber-200 hover:text-amber-400">Accueil</a>
                ...
                <a href="{{route('statistics')}}" class="text-amber-200 hover:text-amber-400">statistiques</a>
                    ...
                    <form action="{{ route('save_recipe') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="mb-6">
                                    <label for="titre" class="block text-gold font-semibold mb-2">Catégorie</label>
                                    <input type="text" name="categorie" id="titre" required
                                        class="w-full bg-white bg-opacity-10 text-white border border-gold border-opacity-30 rounded-lg px-4 py-3 focus:outline-none form-input"
                                        placeholder="Entrées , Plats, Desserts ou Boissons ">
                                    <span id="titreError" class="text-red-400 text-sm hidden">Le titre est requis</span>
                                </div>
                            </div>
                        </div>
